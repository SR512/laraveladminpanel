                ...
                <tr>
                    <td class="header">
                        <a href="" style="display: inline-block;">
                            <img src="{{asset('storage/logo'.DIRECTORY_SEPARATOR.config('constants.LOGO_FILE_NAME'))}}"
                                ...
                                <td class="" width="100%">
                                    ...
                                    <div class="nhsuk-footer" id="nhsuk-footer">
                                        <div class="nhsuk-width-container">
                                            <center>
                                                <p class="nhsuk-footer__copyright">Powered by <a
                                                        class="nhsuk-footer__list-item-link" target="_blank"
                                                        href="https://caprihealthcare.co.uk/" alt="Caprihealthcare">Caprihealthcare</a>
                                                    ...
                                                    <a class="nhsuk-footer__list-item-link" target="_blank"
                                                       ...
                                                       alt="{{config('constants.APP_NAME')}}">
                                                        <img
                                                            src="https://www.caprihealth.net/assets/images/v-consult.png"
